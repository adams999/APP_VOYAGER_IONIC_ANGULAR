...
export class AppComponent {
  ...
  public cliente = {
    "client": "VOYAGER TRAVEL ASSISTANCE",
    "id_country": "VE",
    "img_cliente": "319_1_20150429041948.png",
    "web": "https:\/\/voyagerassist.com",
    "urlPrueba": "https:\/\/voyagerassist.com",
    "prefix": "VY",
    "type_platform": "1",
    "id_broker": '',
    "email": null,
    "colors_platform": "{\n  \"COLOR_MENU_BACKEND\": \"#a8a13d\",\n  \"color_tr_table\": \"#d4c7b2\",\n  \"color_font_tr\": \"#e6e6e6\",\n  \"color_login\": \"#f6f6f6\",\n  \"color_menu\": \"#b8b8b1\",\n  \"color_menu_barra\": \"#b8724a\",\n  \"color_menu_barra_hover\": \"#b8724a\",\n  \"color_font_tab\": \"#c9bcb9\",\n  \"color_email_font\": \"#3b362f\",\n  \"email_shadow_table\": \"#eddc7c\"\n}"
  };
  ...
  constructor(public platform: Platform,
    ...
    network.onConnect().subscribe(() => {
      ...
      this.userType ? this.navCtrl.navigateRoot('/list-orders') : navCtrl.navigateRoot('/login/VY');;
  ...
  sessionColores(colorsPlatform, cliente) {
    if (localStorage.getItem('paramAgency') != 'N/A' && localStorage.getItem('paramAgency')) {
      ...
      localStorage.setItem("nomClient", 'VOYAGER TRAVEL ASSISTANCE');
    }
  }
